				...
				<ul class="layui-nav layui-nav-tree"  lay-filter="test">
					...
					<li class="layui-nav-item">
						...
						<dl class="layui-nav-child">
							...
							<dd><a href="${pageContext.request.contextPath}/isCurrAppraiseList" target="main_self_frame">学期开启</a></dd>
						</dl>
					</li>
					<li class="layui-nav-item">
					...
					<li class="layui-nav-item">
						...
						<dl class="layui-nav-child">
							...
							<dd><a href="${pageContext.request.contextPath}/Tt_score" target="main_self_frame">同行教师评教分数</a></dd>
						</dl>
					</li>
					<li class="layui-nav-item">
